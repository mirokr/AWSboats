...
import com.boats.price.nci.integrations.PredictionRestClient;
...
//		calc = Math.exp(calc);
		...
		boat.setPrice_prediction(client.updatePrediction(boat).getPrice_prediction());
...
//		boatT.setPrice_prediction(calc);
		boatT.setPrice_prediction(client.updatePrediction(boatT).getPrice_prediction());
